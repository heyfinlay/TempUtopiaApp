                ...
                <CardHeader className="space-y-3">
                  ...
                  <div className="rounded-xl border border-[var(--m-border)] bg-[var(--m-surface-soft)] p-3">
                    {card.title === "Lead conversation" ? (
                      <div className="space-y-2 text-[length:var(--m-text-sm)]">
                    ...
                    {card.title === "Booked appointment" ? (
                      <div className="space-y-2 text-[length:var(--m-text-sm)] text-[color:var(--m-text)]">
                        <div className="rounded-lg border border-[var(--m-border)] bg-white px-3 py-2">Tuesday</div>
                        <div className="rounded-lg border border-[var(--m-border)] bg-emerald-50 px-3 py-2">10:30 AM confirmed</div>
                      </div>
                    ) : null}
