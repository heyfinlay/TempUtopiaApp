...
export function SystemStepsCarousel() {
  ...
  return (
    <section id="system-diagram" className="py-20 md:py-24">
      <div className="mx-auto max-w-6xl space-y-6 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-3xl space-y-2">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">System Steps</p>
            <h2 className="text-3xl font-semibold text-slate-900">Here’s the system we install.</h2>
          ...
          >
            {systemSteps.map((step, index) => (
              ...
              >
                <Card
                  className={cn(
                    "h-full border-slate-200 bg-white shadow-sm transition-colors",
